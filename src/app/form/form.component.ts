...
@Component({
  ...
  imports: [MatDialogModule, ReactiveFormsModule, MatButtonModule, MatFormFieldModule, MatInputModule, HttpClientModule],
})
export class FormDialog {
    ...
    constructor(private DbService: DbService, private formBuilder: FormBuilder, private http: HttpClient, private dialog: MatDialog){
    ...
    this.subscription = this.cardForm.get('certNumber')!.valueChanges
        .pipe(
